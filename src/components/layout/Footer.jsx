      ...
      <div className="container mx-auto px-padding-small md:px-padding-big">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-400 max-w-md font-montserrat">
              Transformando el cuidado cognitivo mediante tecnología innovadora y conexión familiar.
            </p>
          ...
          <div className="footer-part footer-02">
            <h3 className="font-semibold text-lg mb-6 font-figtree">Links Rápidos</h3>
          ...
          <div className="footer-part footer-03">
            <h3 className="font-semibold text-lg mb-6 font-figtree">Contacto Rápido</h3>
            <ul className="space-y-4">
            ...
            {/* Downloads */}
            <div className="mt-8">
              <h4 className="font-medium text-gray-300 mb-4">Próximamente en:</h4>
        ...
        <div className="border-t border-gray-800 pt-8 pb-10 text-center">
          <p className="text-gray-400 font-montserrat">
            &copy; {currentYear} Cognicise. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
